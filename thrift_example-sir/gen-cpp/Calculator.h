...
class Calculator_subtract_args {
 public:
  ...
  Calculator_subtract_args(const Calculator_subtract_args&);
  Calculator_subtract_args& operator=(const Calculator_subtract_args&);
  Calculator_subtract_args() : num1(0), num2(0) {
  }
...
class Calculator_subtract_result {
 public:
  ...
  Calculator_subtract_result(const Calculator_subtract_result&);
  Calculator_subtract_result& operator=(const Calculator_subtract_result&);
  Calculator_subtract_result() : success(0) {
  }
